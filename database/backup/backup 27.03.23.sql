...
(56,4,'<p><span style=\"background-color: rgb(255, 255, 255);\">DEQUAZOL ORAL 500 MG</span></p>','<p>METRONIDAZOL</p>','<p>TABLETA</p>','<p>.</p>','2027-02-28'),
...
(72,12,'<p><span style=\"background-color: rgb(255, 255, 255);\">ESPIRONOLACTONA 25 MG</span></p>','<p>ESPIRONOLACTONA</p>','<p>TABLETA</p>','<p>.</p>','2026-10-30'),
...
(87,9,'<p><span style=\"background-color: rgb(255, 255, 255);\">FERANIN 100 MG</span></p>','<p>HIERRO</p>','<p>GRAGEAS</p>','<p>.</p>','2024-06-30'),
...
(131,15,'<p><span style=\"background-color: rgb(241, 196, 15);\">MEDROL 16 MG</span></p>','<p>METILPREDNISOLONA</p>','<p>TABLETA</p>','<p>PR&Oacute;XIMO A VENCER</p>','2023-12-30'),
...
(152,8,'<p><span style=\"background-color: rgb(255, 255, 255);\">PANTOPRAZOL 40 MG</span></p>','<p>PANTOPRAZOL</p>','<p>TABLETA</p>','<p>.</p>','2024-02-28'),
...
(165,16,'<p><span style=\"background-color: rgb(255, 255, 255);\">PYRIDIUM 100 MG</span></p>','<p>FENAZOPIRIDINA</p>','<p>TABLETA</p>','<p>.</p>','2025-04-30'),
(168,12,'<p>PROPANOLOL 40 MG</p>','<p>PROPANOLOL</p>','<p>TABLETA</p>','<p>.</p>','2025-05-30'),
(169,16,'<p><span style=\"background-color: rgb(255, 255, 255);\">PONSTAN 220 MG</span></p>','<p>NAPROXENO S&Oacute;DICO</p>','<p>TABLETA</p>','<p>.</p>','2024-02-28'),
...
(193,7,'<p><span style=\"background-color: rgb(255, 255, 255);\">ZENTEL 400 MG</span></p>','<p>ALBENDAZOL</p>','<p>TABLETA</p>','<p>.</p>','2025-06-30'),
...
(213,11,'<p><span style=\"background-color: rgb(241, 196, 15);\">CONSTULOSA 3.33G/5ML</span></p>','<p>LACTULOSA</p>','<p>SUSPENSION ORAL</p>','<p>PR&Oacute;XIMO A VENCER</p>','2023-11-30'),
...
(279,5,'<p><span style=\"background-color: rgb(241, 196, 15);\">DOLO NEUROBION</span></p>','<p>Diclofenaco + Complejo B (B1, B6, B12)</p>','<p>AMPOLLA</p>','<p>PR&Oacute;XIMO A VENCER</p>','2023-06-30'),
...
(298,15,'<p><span style=\"background-color: rgb(241, 196, 15);\">LIKFERR 100 MG/ 5ML</span></p>','<p>HIERRRO SACAROSA</p>','<p>AMPOLLA</p>','<p>PR&Oacute;XIMO A VENCER</p>','2023-09-30'),
...
(354,4,'<p><span style=\"background-color: rgb(241, 196, 15);\">UNITOB - S</span></p>','<p>TOBRAMICINA + DEXAMETASONA</p>','<p>GOTAS OFTALMICAS</p>','<p>PR&Oacute;XIMO A VENCER</p>','2023-08-30'),
...
(507,17,'<p>ESPASMO ANTANGINA TAB</p>','<p>&nbsp;Metamizol S&oacute;dico + Escopolamina Butil Hidr&oacute;xido</p>','<p>TABLETA</p>','<p>.</p>','2025-07-31'),
(508,9,'<p>FERANIN FORTE 50 MG/ML&nbsp;</p>','<p>HIERRO</p>','<p>GOTAS</p>','<p>.</p>','2025-07-31'),
(509,15,'<p>CLORURO DE POTASIO 20%</p>','<p>CLORURO DE POTASIO</p>','<p>AMPOLLA</p>','<p>.</p>','2024-10-31');
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_emailnoexiste_registrado`(IN `_email` VARCHAR(50))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_nombreproducto_registrado`(IN `_nombreproducto` VARCHAR(50))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_nombreusuario_registrado`(IN `_nombreusuario` VARCHAR(25))
BEGIN
	SELECT * FROM usuarios 
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_productos_filtrar_categorias`(IN `_idcategoria` INT)
BEGIN
	SELECT * FROM productos
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_productos_modificar`(IN `_idproducto` INT, IN `_nombreproducto` TEXT, IN `_principiosactivos` TEXT, IN `_formafarmaceutica` TEXT, IN `_descripcion` TEXT, IN `_fechavencimiento` DATE)
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_productos_registro`(IN `_idcategoria` INT, IN `_nombreproducto` TEXT, IN `_principiosactivos` TEXT, IN `_formafarmaceutica` TEXT, IN `_descripcion` TEXT, IN `_fechavencimiento` DATE)
BEGIN	
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_usuarios_actualizarclave`(IN `_idusuario` INT, IN `_clave` VARCHAR(100))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_usuarios_login`(IN `_nombreusuario` VARCHAR(25))
BEGIN
	SELECT idusuario, nombres, apellidos, nombreusuario, clave, fechacreacion, fechabaja, 
		CASE 
			WHEN nivelacceso = "A" THEN "Administrador"
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_usuarios_modificar`(IN `_idusuario` INT, IN `_nombreusuario` VARCHAR(25), IN `_nivelacceso` CHAR(1), IN `_email` VARCHAR(50))
BEGIN
	UPDATE usuarios SET
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_usuarios_registro`(IN `_nombres` VARCHAR(50), IN `_apellidos` VARCHAR(50), IN `_nombreusuario` VARCHAR(25), IN `_nivelacceso` CHAR(1), IN `_email` VARCHAR(80))
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `spu_usuario_codverificacion`(IN `_idusuario` INT, IN `_codverificacion` CHAR(6))
BEGIN 
	UPDATE usuarios SET
